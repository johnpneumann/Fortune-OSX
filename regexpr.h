...
Small changes made by Christopher J. Kane 94/01/19 marked with "(cjk)",
for the NeXT system.  Changes also made to regexpr.c.
 - hide re_comp(), re_exec()
 - renamed re_match.* to re_match_pattern.* and re_search.* to
   re_search_pattern.* to avoid tiresome library conflicts on NeXT
   (re_match conflicted)
...
int re_match_pattern(regexp_t compiled, char *string, int size, int pos,
...
int re_match_pattern_2(regexp_t compiled, char *string1, int size1,
...
int re_search_pattern(regexp_t compiled, char *string, int size, int startpos,
...
int re_search_pattern_2(regexp_t compiled, char *string1, int size1,
...
int re_match_pattern();
int re_match_pattern_2();
int re_search_pattern();
int re_search_pattern_2();
